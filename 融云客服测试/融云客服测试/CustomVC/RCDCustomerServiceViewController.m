...
//        [textCell.bubbleBackgroundView setBackgroundColor:RGBCOLOR(24, 108, 158)];
        ...
        //        textCell.textLabel.xxj_x = 0;
        
//        if (textCell.messageDirection == 1)//发送
//        {
//            textCell.bubbleBackgroundView.xxj_x = 0;
//        }
//        else if (textCell.messageDirection == 2)//接受
//        {
//            textCell.bubbleBackgroundView.xxj_x = 0;
//        }
...
//    UIImageView * backImageView = [[UIImageView alloc]initWithImage:[[UIImage imageNamed:@"BG"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal]];
//    [BaseCell.contentView insertSubview:backImageView atIndex:0];
    
    
    [BaseCell.contentView setBackgroundColor:[UIColor colorWithPatternImage:[[UIImage imageNamed:@"BG"]imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal]]];
    
    BaseCell.messageContentView.backgroundColor = [UIColor yellowColor];
    
    
    BaseCell.messageTimeLabel.backgroundColor = [UIColor clearColor];
    
    if (BaseCell.messageDirection == 1)
    {
        BaseCell.messageContentView.xxj_x = WIDTH - BaseCell.messageContentView.xxj_width - 10;
    }
    else
    {
        BaseCell.messageContentView.xxj_x = 10;
    }
